<!-- $Id: goods_info.htm 14132 2008-02-13 03:29:03Z fenghl $ -->
...
?>
          ...
          <tr>
            ...
            <td><select name="brand_id" onchange="hideBrandDiv()" ><option value="0"><?php echo $this->_var['lang']['select_please']; ?></caption><?php echo $this->html_options(array('options'=>$this->_var['brand_list'],'selected'=>$this->_var['goods']['brand_id'])); ?></select>
              <?php if ($this->_var['is_add']): ?>
...
?>
          ...
          <tr>
            ...
            <td><input type="text" name="give_integral" value="<?php echo $this->_var['goods']['give_integral']; ?>" size="20" /></td>
          </tr>
          <tr>
            ...
            <td><input type="text" name="integral" value="<?php echo $this->_var['goods']['integral']; ?>" size="20" />
          ...
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_course_start_date']; ?></td>
            <td><input type="text" name="course_start_date" value="<?php echo $this->_var['goods']['course_start_date']; ?>" size="30" /></td>
          </tr>          
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_course_start_time']; ?></td>
            <td><input type="text" name="course_start_time" value="<?php echo $this->_var['goods']['course_start_time']; ?>" size="30" /></td>
          </tr> 
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_course_recruit_goal']; ?></td>
            <td><input type="text" name="course_recruit_goal" value="<?php echo $this->_var['goods']['course_recruit_goal']; ?>" size="30" /></td>
          </tr> 
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_course_material']; ?></td>
            <td><input type="text" name="course_material" value="<?php echo $this->_var['goods']['course_material']; ?>" size="30" /></td>
          </tr> 
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_course_goal']; ?></td>
            <td><input type="text" name="course_goal" value="<?php echo $this->_var['goods']['course_goal']; ?>" size="30" /></td>
          </tr> 
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_course_teacher_desc']; ?></td>
            <td><input type="text" name="course_teacher_desc" value="<?php echo $this->_var['goods']['course_teacher_desc']; ?>" size="30" /></td>
          </tr>                               
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_course_address']; ?></td>
            <td><input type="text" name="course_address" value="<?php echo $this->_var['goods']['course_address']; ?>" size="30" /></td>
          </tr>           
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_course_address_map']; ?></td>
            <td><input type="text" name="course_address_map" value="<?php echo $this->_var['goods']['course_address_map']; ?>" size="30" /></td>
          </tr> 
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_course_telephone']; ?></td>
            <td><input type="text" name="course_telephone" value="<?php echo $this->_var['goods']['course_telephone']; ?>" size="30" /></td>
          </tr> 
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_course_desc']; ?></td>
            <td><input type="text" name="course_desc" value="<?php echo $this->_var['goods']['course_desc']; ?>" size="30" /></td>
          </tr> 
          ...
          <tr id="auto_thumb_1">
            ...
            <td id="auto_thumb_3">
              ...
              <?php else: ?>
                <img src="images/no.gif" />
              <?php endif; ?><?php if ($this->_var['gd'] > 0): ?>
        ...
        <table width="90%" id="mix-table" style="display:none" align="center">
          ...
          <tr>
            ...
            <td><input type="text" name="goods_number" value="<?php echo $this->_var['goods']['goods_number']; ?>" size="20" <?php if ($this->_var['code'] != ''): ?>readonly="readonly"<?php endif; ?> /></td>
          </tr>
          <tr>
        ...
        <table width="90%" id="properties-table" style="display:none" align="center">
          <tr>
              <td class="label"><?php echo $this->_var['lang']['goods_type']; ?></td>
              <td>
        ...
        <table width="90%" id="linkgoods-table" style="display:none" align="center">
          ...
          <tr>
            <td colspan="3">
              ...
              <select name="cat_id1"><option value="0"><?php echo $this->_var['lang']['all_category']; ?></caption><?php echo $this->_var['cat_list']; ?></select>
              <select name="brand_id1"><option value="0"><?php echo $this->_var['lang']['all_brand']; ?></caption><?php echo $this->html_options(array('options'=>$this->_var['brand_list'])); ?></select>
...
?>
        ...
        <table width="90%" id="groupgoods-table" style="display:none" align="center">
          ...
          <tr>
            <td colspan="3">
              <img src="images/icon_search.gif" width="26" height="22" border="0" alt="SEARCH" />
              <select name="cat_id2"><option value="0"><?php echo $this->_var['lang']['all_category']; ?></caption><?php echo $this->_var['cat_list']; ?></select>
              <select name="brand_id2"><option value="0"><?php echo $this->_var['lang']['all_brand']; ?></caption><?php echo $this->html_options(array('options'=>$this->_var['brand_list'])); ?></select>
...
<script language="JavaScript">
  ...
  var integralPercent = <?php echo $this->_var['cfg']['integral_percent']; ?>;
