<!-- $Id: goods_list.htm 13167 2007-10-25 02:12:20Z wj $ -->
...
?>
  <tr>
    ...
    <?php if ($this->_var['use_storage']): ?>
    <td align="right"><?php if ($this->_var['code'] == 'virtual_card'): ?><?php echo $this->_var['goods']['goods_number']; ?><?php else: ?><span onclick="listTable.edit(this, 'edit_goods_number', <?php echo $this->_var['goods']['goods_id']; ?>)"><?php echo $this->_var['goods']['goods_number']; ?></span><?php endif; ?></td>
    <?php endif; ?>
    <td align="center">
