...
$_LANG['goods_stat'] = '实体课程统计信息';
$_LANG['virtual_card_stat'] = '虚拟卡课程统计';
$_LANG['goods_count'] = '课程总数：';
$_LANG['sales_count'] = '促销课程数：';
$_LANG['new_goods'] = '新品推荐数：';
$_LANG['recommed_goods'] = '精品推荐数：';
$_LANG['hot_goods'] = '热销课程数：';
$_LANG['warn_goods'] = '库存警告课程数：';
...
$_LANG['images_cannt_write']= '您将无法上传任何课程图片。';
...
$_LANG['good_name'] = '课程名称';
$_LANG['good_number'] = '课程数量';
$_LANG['good_category'] = '课程分类';
$_LANG['good_brand'] = '课程品牌';
$_LANG['good_price'] = '课程价格';
$_LANG['good_brief'] = '课程描述';
$_LANG['good_image'] = '上传课程图片';
$_LANG['is_new'] = '新品';
$_LANG['is_best'] = '精品';
$_LANG['is_hot'] = '热卖';
...
$_LANG['js_languages']['good_name_not_null'] = '课程名称不能为空';
$_LANG['js_languages']['good_category_not_null'] = '课程分类不能为空';
$_LANG['js_languages']['good_number_not_number'] = '课程数量不是数值';
$_LANG['js_languages']['good_price_not_number'] = '课程价格不是数值';
