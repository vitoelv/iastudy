...
$_LANG['template_files']['category'] = '课程分类页模板';
$_LANG['template_files']['flow'] = '购物流程模板';
$_LANG['template_files']['goods'] = '课程详情模板';
$_LANG['template_files']['group_buy_goods'] = '团购课程详情模板';
$_LANG['template_files']['group_buy_list'] = '团购课程列表模板';
$_LANG['template_files']['index'] = '首页模板';
$_LANG['template_files']['search'] = '课程搜索模板';
$_LANG['template_files']['compare'] = '课程比较模板';
$_LANG['template_files']['snatch'] = '夺宝奇兵';
$_LANG['template_files']['tag_cloud'] = '标签云模板';
$_LANG['template_files']['brand'] = '课程品牌页';
...
$_LANG['template_libs']['goods_attrlinked'] = '属性关联的课程';
$_LANG['template_libs']['recommend_best'] = '精品推荐';
$_LANG['template_libs']['recommend_promotion'] = '促销课程';
$_LANG['template_libs']['recommend_hot'] = '热卖课程';
$_LANG['template_libs']['recommend_new'] = '新品上架';
$_LANG['template_libs']['bought_goods'] = '购买过此课程的人还买过的课程';
$_LANG['template_libs']['brand_goods'] = '品牌的课程';
$_LANG['template_libs']['brands'] = '品牌专区';
$_LANG['template_libs']['cart'] = '购物车';
$_LANG['template_libs']['cat_goods'] = '分类下的课程';
$_LANG['template_libs']['category_tree'] = '课程分类树';
...
$_LANG['template_libs']['goods_gallery'] = '课程相册';
$_LANG['template_libs']['goods_article'] = '相关文章';
$_LANG['template_libs']['goods_list'] = '课程列表';
$_LANG['template_libs']['goods_tags'] = '课程标记';
$_LANG['template_libs']['group_buy'] = '团购课程';
$_LANG['template_libs']['group_buy_fee'] = '团购课程费用总计';
$_LANG['template_libs']['help'] = '帮助内容';
$_LANG['template_libs']['history'] = '课程浏览历史';
...
$_LANG['template_libs']['goods_related'] = '相关课程';
...
$_LANG['template_libs']['auction'] = '拍卖课程';
...
$_LANG['template_libs']['categorys'] = '课程分类';
