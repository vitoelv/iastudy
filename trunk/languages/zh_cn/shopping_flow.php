...
/* 课程书包 */
$_LANG['update_cart'] = '更新课程书包';
$_LANG['back_to_cart'] = '返回课程书包';
$_LANG['update_cart_notice'] = '课程书包更新成功，请您重新选择您需要的赠品。';
$_LANG['direct_shopping'] = '不打算登录，直接报名';
$_LANG['goods_not_exists'] = '对不起，指定的课程不存在';
$_LANG['drop_goods_confirm'] = '您确实要把该课程移出课程书包吗？';
$_LANG['goods_number_not_int'] = '请您输入正确的课程数量。';
$_LANG['stock_insufficiency'] = '非常抱歉，您选择的课程 %s 已经满员，您可以预约报名。';
$_LANG['shopping_flow'] = '报名流程';
$_LANG['username_exists'] = '您输入的用户名已存在，请换一个试试。';
$_LANG['username_exists2'] = '您输入的用户名已存在或您输入的其它数据不正确，请重试。';
...
$_LANG['no_goods_in_cart'] = '您的课程书包中没有课程！';
$_LANG['not_submit_order'] = '您参与本次团报课程的订单已提交，请勿重复操作！';
$_LANG['pay_success'] = '本次支付已经成功，我们将尽快与您联系确认。';
...
$_LANG['storage_short'] = '满员';
$_LANG['subtotal'] = '小计';
$_LANG['savemoney'] = '立刻节省';
$_LANG['accessories'] = '相关资源';
$_LANG['largess'] = '赠品';
$_LANG['shopping_money'] = '课程金额小计 %s';
$_LANG['than_market_price'] = '比原价 %s 节省了 %s (%s)';
$_LANG['your_discount'] = '根据优惠活动<a href="activity.php"><font color=red>%s</font></a>，您可以享受折扣 %s';
$_LANG['no'] = '无';
$_LANG['not_support_virtual_goods'] = '课程书包中存在非实体课程,不支持匿名报名,请登陆后再报名';
$_LANG['not_support_insure'] = '不支持保价';
$_LANG['clear_cart'] = '清空课程书包';
...
$_LANG['far_ext'][FAR_ALL] = '全部课程';
$_LANG['far_ext'][FAR_BRAND] = '以下学校';
$_LANG['far_ext'][FAR_CATEGORY] = '以下分类';
$_LANG['far_ext'][FAR_GOODS] = '以下课程';
...
$_LANG['bonus_min_amount_error'] = '报名单课程金额没有达到使用该红包的最低金额 %s';
