 ...
 * $Id: group_buy.php 13757 2007-11-26 13:10:53Z refly $
*/

/* 目前頁面標題及可用連結名稱 */
$_LANG['group_buy_list'] = '團購活動列表';
$_LANG['add_group_buy'] = '新增團購活動';
...
$_LANG['gift_integral'] = '贈送積點';
$_LANG['valid_order'] = '訂單';
$_LANG['valid_goods'] = '訂購商品';
$_LANG['current_price'] = '目前價格';
...
$_LANG['notice_goods_name'] = '請先搜尋商品,在此產生選項列表...';
...
$_LANG['add_success'] = '新增團購活動成功。';
$_LANG['edit_success'] = '編輯團購活動成功。';
$_LANG['back_list'] = '返回團購活動列表。';
$_LANG['continue_add'] = '繼續新增團購活動。';
...
$_LANG['js_languages']['error_gift_integral'] = '您輸入的贈送積點數不是整數！';

/* 刪除團購活動 */
$_LANG['js_languages']['batch_drop_confirm'] = '您確定要刪除選定的團購活動嗎？';
$_LANG['error_exist_order'] = '該團購活動已經有訂單，不能刪除！';
$_LANG['batch_drop_success'] = '成功刪除了 %s 筆團購活動記錄（已經有訂單的團購活動不能刪除）。';
$_LANG['no_select_group_buy'] = '您目前沒有任何團購活動的紀錄可供刪除！';
