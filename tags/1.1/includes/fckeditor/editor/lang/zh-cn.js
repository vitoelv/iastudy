...
DlgImgLinkTab		: "链接",
DlgInvalidfiletype  : "文件类型不匹配",
DlgFileRename       : "文件同名，新文件被改名为:\"{filename}\"",
DlgOtherError       : "文件上传失败，未知错误:",
DlgSecurityerror    : "您还没有登陆或登陆超时，请重新登陆。",
DlgUploaded         : "文件上传成功",
//206-210行上传文件提示信息的语言项  modified by liupeng(ecshop.com) @ 2007-4-2
