...
$_LANG['send_by'][SEND_BY_GOODS] = '按课程发放';
...
$_LANG['goods_cat'] = '选择课程分类';
$_LANG['goods_brand'] = '课程品牌';
$_LANG['goods_key'] = '课程关键字';
$_LANG['all_goods'] = '可选课程';
$_LANG['send_bouns_goods'] = '发放此类型红包的课程';
$_LANG['remove_bouns'] = '移除红包';
$_LANG['all_remove_bouns'] = '全部移除';
$_LANG['goods_already_bouns'] = '该课程已经发放过其它类型的红包了!';
