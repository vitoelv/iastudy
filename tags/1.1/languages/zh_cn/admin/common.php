...
$_LANG['app_name'] = 'IAStudy';
$_LANG['cp_home'] = 'IAStudy 管理中心';
$_LANG['copyright'] = '版权所有 &copy; 2008-2009 我爱学习网，并保留所有权利。';
...
/* 课程管理 */
$_LANG['01_goods_list'] = '课程列表';
$_LANG['02_goods_add'] = '添加新课程';
$_LANG['03_category_list'] = '课程分类';
$_LANG['04_category_add'] = '添加分类';
$_LANG['05_comment_manage'] = '用户评论';
$_LANG['06_goods_brand_list'] = '课程品牌';
$_LANG['07_brand_add'] = '添加品牌';
$_LANG['08_goods_type'] = '课程类型';
$_LANG['09_attribute_list'] = '课程属性';
$_LANG['10_attribute_add'] = '添加属性';
$_LANG['11_goods_trash'] = '课程回收站';
$_LANG['12_batch_pic'] = '图片批量处理';
$_LANG['13_batch_add'] = '课程批量上传';
$_LANG['15_batch_edit'] = '课程批量修改';
$_LANG['16_goods_script'] = '生成课程代码';
$_LANG['17_tag_manage'] = '标签管理';

$_LANG['14_goods_export'] = '课程批量导出';

$_LANG['50_virtual_card_list'] = '虚拟卡列表';
$_LANG['51_virtual_card_add'] = '添加新虚拟卡';
$_LANG['52_virtual_card_change'] = '更改加密串';
$_LANG['goods_auto'] = '课程自动上下架';
