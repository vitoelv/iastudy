...
$_LANG['cfg_name']['image_width'] = '课程图片宽度';
$_LANG['cfg_name']['image_height'] = '课程图片高度';
$_LANG['cfg_name']['best_number'] = '精品推荐数量';
$_LANG['cfg_name']['new_number'] = '新品推荐数量';
$_LANG['cfg_name']['hot_number'] = '热销课程数量';
$_LANG['cfg_name']['promote_number'] = '特价课程的数量';
$_LANG['cfg_name']['group_goods_number'] = '团购课程的数量';
$_LANG['cfg_name']['top_number'] = '销量排行数量';
$_LANG['cfg_name']['history_number'] = '浏览历史数量';
$_LANG['cfg_name']['comments_number'] = '评论数量';
$_LANG['cfg_name']['bought_goods'] = '相关课程数量';
...
$_LANG['cfg_name']['sn_prefix'] = '课程货号前缀';
...
$_LANG['cfg_name']['comment_factor'] = '课程评论的条件';
$_LANG['cfg_name']['no_picture'] = '课程的默认图片';
$_LANG['cfg_name']['stats_code'] = '统计代码';
$_LANG['cfg_name']['cache_time'] = '缓存存活时间（秒）';
$_LANG['cfg_name']['page_size'] = '课程分类页列表的数量';
$_LANG['cfg_name']['sort_order_type'] = '课程分类页默认排序类型';
$_LANG['cfg_name']['sort_order_method'] = '课程分类页默认排序方式';
$_LANG['cfg_name']['show_order_type'] = '课程分类页默认显示方式';
$_LANG['cfg_name']['goods_name_length'] = '课程名称的长度';
$_LANG['cfg_name']['price_format'] = '课程价格显示规则';
...
$_LANG['cfg_name']['goodsattr_style'] = '课程属性显示样式';
...
$_LANG['cfg_name']['attr_related_number'] = '属性关联的课程数量';
$_LANG['cfg_name']['top10_time'] = '排行统计的时间';
$_LANG['cfg_name']['goods_gallery_number'] = '课程详情页相册图片数量';
...
$_LANG['cfg_name']['related_goods_number'] = '关联课程显示数量';
$_LANG['cfg_name']['visit_stats'] = '站点访问统计';
$_LANG['cfg_name']['help_open'] = '用户帮助是否打开';

$_LANG['cfg_desc']['smtp'] = '设置邮件服务器基本参数';
$_LANG['cfg_desc']['market_price_rate'] = '输入课程售价时将自动根据该比例计算市场价格';
...
$_LANG['cfg_desc']['integral_percent'] = '每100元课程最多可以使用多少元积分';
$_LANG['cfg_desc']['comments_number'] = '显示在课程详情页的用户评论数量。';
...
$_LANG['cfg_desc']['bought_goods'] = '显示多少个购买此课程的人还买过哪些课程';
$_LANG['cfg_desc']['currency_format'] = '显示课程价格的格式，%s将被替换为相应的价格数字。';
$_LANG['cfg_desc']['image_height'] = '如果您的服务器支持GD，在您上传课程图片的时候将自动将图片缩小到指定的尺寸。';
...
$_LANG['cfg_desc']['attr_related_number'] = '在课程详情页面显示多少个属性关联的课程。';
...
$_LANG['cfg_range']['comment_factor']['3'] = '仅购买过该课程用户';
...
$_LANG['cfg_range']['sort_order_type']['1'] = '按课程价格';
