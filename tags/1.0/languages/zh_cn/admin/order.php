...
$_LANG['goods_info'] = '课程信息';
$_LANG['goods_name'] = '课程名称';
$_LANG['goods_name_brand'] = '课程名称 [ 品牌 ]';
$_LANG['goods_sn'] = '货号';
...
$_LANG['label_total_weight'] = '课程总重量：';

$_LANG['label_goods_amount'] = '课程总金额：';
...
$_LANG['js_languages']['confirm_drop'] = '确认要删除该课程吗？';
$_LANG['js_languages']['invalid_goods_number'] = '课程数量不正确';
$_LANG['js_languages']['pls_search_goods'] = '请搜索并选择课程';
