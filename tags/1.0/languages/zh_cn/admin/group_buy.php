...
$_LANG['valid_goods'] = '订购课程';
$_LANG['current_price'] = '当前价格';
$_LANG['current_status'] = '状态';
$_LANG['view_order'] = '查看订单';

/* 添加/编辑活动页 */
$_LANG['goods_cat'] = '课程分类';
$_LANG['all_cat'] = '所有分类';
$_LANG['goods_brand'] = '课程品牌';
$_LANG['all_brand'] = '所有品牌';

$_LANG['label_goods_name'] = '团购课程：';
$_LANG['notice_goods_name'] = '请先搜索课程,在此生成选项列表...';
...
$_LANG['label_goods_qty'] = '课程数 / 有效课程数：';
...
/* 添加/编辑活动提交 */
$_LANG['error_goods_null'] = '您没有选择团购课程！';
$_LANG['error_goods_exist'] = '您选择的课程目前有一个团购活动正在进行！';
$_LANG['error_price_ladder'] = '您没有输入有效的价格阶梯！';
$_LANG['error_restrict_amount'] = '限购数量不能小于价格阶梯中的最大数量';

$_LANG['js_languages']['error_goods_null'] = '您没有选择团购课程！';
...
$_LANG['error_exist_order'] = '该团报活动已经有订单，不能删除！';
$_LANG['batch_drop_success'] = '成功删除了 %s 条团报活动记录（已经有订单的团报活动不能删除）。';
$_LANG['no_select_group_buy'] = '您现在没有团报活动记录！';

/* 操作日志 */
$_LANG['log_action']['group_buy'] = '团报课程';
