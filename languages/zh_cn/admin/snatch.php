...
$_LANG['make_option'] = '请先搜索课程生成选项列表';
$_LANG['keywords'] = '课程关键字';
...
/* 提示信息 */
$_LANG['no_goods'] = '你输入的课程不存在，请查证后再输入';
...
$_LANG['js_languages']['search_is_null'] = '没有搜索到任何课程，请重新搜索';
