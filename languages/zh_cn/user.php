...
$_LANG['label_group_buy'] = '我的团报';
$_LANG['label_booking'] = '预订登记';
...
/* 缺货登记 */
$_LANG['oos_booking'] = '预订登记';
$_LANG['booking_goods_name'] = '预订课程名';
$_LANG['booking_amount'] = '预订数量';
$_LANG['booking_time'] = '登记时间';
$_LANG['process_desc'] = '处理备注';
$_LANG['describe'] = '预订描述';
$_LANG['contact_username'] = '联系人';
$_LANG['contact_phone'] = '联系电话';
$_LANG['submit_booking_goods'] = '提交预订登记';
$_LANG['booking_success'] = '您的课程预订登记已经成功提交！';
$_LANG['booking_rec_exist'] = '此课程您已经进行过预订登记了！';
$_LANG['back_booking_list'] = '返回预订登记列表';
$_LANG['not_dispose'] = '未处理';
$_LANG['no_goods_id'] = '请指定课程ID';

//JS语言项
$_LANG['booking_js']['booking_amount_empty'] = '请输入您要报名的课程数量！';
$_LANG['booking_js']['booking_amount_error'] = '您输入的报名数量格式不正确！';
$_LANG['booking_js']['describe_empty'] = '请输入您的报名描述信息！';
...
/* 会员订单 */
$_LANG['order_list_lnk'] = '我的报名单列表';
$_LANG['order_number'] = '报名单编号';
$_LANG['order_addtime'] = '报名时间';
$_LANG['order_money'] = '课程总金额';
$_LANG['order_status'] = '报名单状态';
$_LANG['first_order'] = '主报名单';
$_LANG['second_order'] = '从报名单';
$_LANG['merge_order'] = '合并报名单';
$_LANG['no_priv'] = '你没有权限操作他人报名单';
$_LANG['buyer_cancel'] = '用户取消';
$_LANG['cancel'] = '取消报名';
$_LANG['pay_money'] = '付款';
$_LANG['view_order'] = '查看报名单';
$_LANG['received'] = '确认收货';
$_LANG['ss_received'] = '已完成';
$_LANG['confirm_cancel'] = '您确认要取消该课程吗？取消后此报名单将视为无效报名单';
$_LANG['merge_ok'] = '报名单合并成功！';
$_LANG['merge_invalid_order'] = '对不起，您选择合并的报名单不允许进行合并的操作。';
$_LANG['select'] = '请选择...';
$_LANG['order_not_pay'] = "你的报名单状态为 %s ,不需要付款";
$_LANG['order_sn_empty'] = '合并主报名单号不能为空';
$_LANG['merge_order_notice'] = '报名单合并是在实际报名前将相同状态的报名单合并成一新的报名单。<br />报名人信息等以主报名单为准。';
$_LANG['order_exist'] = '该报名单不存在！';
$_LANG['order_is_group_buy'] = '[团报]';
$_LANG['gb_deposit'] = '（保证金）';
$_LANG['notice_gb_order_amount'] = '（备注：团报如果有保证金，第一次只需支付保证金和相应的支付费用）';
$_LANG['business_message'] = '发送/查看老师留言';
$_LANG['pay_order_by_surplus'] = '追加使用余额支付订单：%s';
$_LANG['return_surplus_on_cancel'] = '取消报名单 %s，退回支付报名单时使用的预付款';
$_LANG['return_integral_on_cancel'] = '取消报名单 %s，退回支付报名单时使用的积分';
...
$_LANG['current_os_not_unconfirmed'] = '当前报名单状态不是“未确认”。';
$_LANG['current_os_already_confirmed'] = '当前报名单已经被确认，无法取消，请与老师联系。';
$_LANG['current_ss_not_cancel'] = '只有在未确认状态下才能取消，你可以与老师联系。';
$_LANG['current_ps_not_cancel'] = '只有未付款状态才能取消，要取消请联系老师。';
$_LANG['confirm_received'] = '你确认已经参加该课程了吗？';

/* 合并订单及订单详情 */
$_LANG['merge_order_success'] = '合并的报名单的操作已成功！';
$_LANG['merge_order_failed']  = '合并的报名单的操作失败！请返回重试！';
$_LANG['order_sn_not_null'] = '请填写要合并的报名单号';
$_LANG['two_order_sn_same'] = '要合并的两个报名单号不能相同';
$_LANG['order_not_exist'] = "报名单 %s 不存在";
$_LANG['os_not_unconfirmed_or_confirmed'] = " %s 的报名单状态不是“未确认”或“已确认”";
$_LANG['ps_not_unpayed'] = "报名单 %s 的付款状态不是“未付款”";
$_LANG['ss_not_unshipped'] = "报名单 %s 的确认状态不是“未确认”";
$_LANG['order_user_not_same'] = '要合并的两个报名单不是同一个用户下的';
$_LANG['from_order_sn'] = '第一个报名单号：';
$_LANG['to_order_sn'] = '第二个报名单号：';
$_LANG['merge'] = '合并';
$_LANG['notice_order_sn'] = '当两个报名单不一致时，合并后的报名单信息（如：支付方式、配送方式、包装、贺卡、红包等）以第二个为准。';
$_LANG['subtotal'] = '小计';
$_LANG['goods_price'] = '课程价格';
$_LANG['goods_attr'] = '属性';
$_LANG['use_balance'] = '使用余额';
$_LANG['order_postscript'] = '报名单附言';
$_LANG['order_number'] = '报名单号';
$_LANG['consignment'] = '确认报名单';
$_LANG['shopping_money'] = '课程总价';
$_LANG['invalid_order_id'] = '报名单号错误';
$_LANG['shipping'] = '配送方式';
$_LANG['payment'] = '支付方式';
$_LANG['use_pack'] = '使用包装';
$_LANG['use_card'] = '使用贺卡';
$_LANG['order_total_fee'] = '课程总金额';
...
$_LANG['order_detail'] = '报名单详情';
$_LANG['error_surplus_invalid'] = '您输入的数字不正确！';
$_LANG['error_order_is_paid'] = '该报名单不需要付款！';
$_LANG['error_surplus_not_enough'] = '您的帐户余额不足！';

/* 订单状态 */
$_LANG['detail_order_sn'] = '报名单号';
$_LANG['detail_order_status'] = '报名单状态';
$_LANG['detail_pay_status'] = '付款状态';
$_LANG['detail_shipping_status'] = '配送状态';
$_LANG['detail_order_sn'] = '报名单号';
$_LANG['detail_to_buyer'] = '老师留言';
...
$_LANG['your_order'] = '报名单';
$_LANG['your_integral'] = '积分';
$_LANG['your_level'] = '您的等级是 %s ';
$_LANG['next_level'] = ',您还差 %s 积分达到 %s ';
$_LANG['attention'] = '关注';
$_LANG['no_attention'] = '取消关注';
$_LANG['del_attention'] = '确认取消此课程的关注么？';
$_LANG['add_to_attention'] = '确定将此课程加入关注列表么？';
$_LANG['label_need_image'] = '是否显示课程图片：';
$_LANG['need'] = '显示';
$_LANG['need_not'] = '不显示';
$_LANG['horizontal'] = '横排';
$_LANG['verticle'] = '竖排';
$_LANG['generate'] = '生成代码';
$_LANG['label_goods_num'] = '显示课程数量：';
$_LANG['label_arrange'] = '选择课程排列方式：';
$_LANG['label_charset'] = '选择编码：';
$_LANG['charset']['utf8'] = '国际化编码（utf8）';
$_LANG['charset']['zh_cn'] = '简体中文';
$_LANG['charset']['zh_tw'] = '繁体中文';
$_LANG['goods_num_must_be_int'] = '课程数量应该是整数';
$_LANG['goods_num_must_over_0'] = '课程数量应该大于0';

$_LANG['last_month_order'] = '您最近30天内报名了';
$_LANG['order_unit'] = '个课程';
$_LANG['please_received'] = '以下课程已确认';
...
/* 合并订单js */
$_LANG['merge_order_js']['from_order_empty'] = '请选择要合并的从报名单';
$_LANG['merge_order_js']['to_order_empty'] = '请选择要合并的主报名单';
$_LANG['merge_order_js']['order_same'] = '主报名单和从报名单相同，请重新选择';
$_LANG['merge_order_js']['confirm_merge'] = '您确实要合并这两个报名单吗？';

/* 将用户订单中课程加入购物车 */
$_LANG['order_id_empty'] = '未指定报名单号';
$_LANG['return_to_cart_success'] = '报名单中课程已经成功加入课程书包中';
...
$_LANG['affiliate_intro'][0] = '　　本站为鼓励推荐新用户注册，现开展<b>推荐注册分成</b>活动，活动流程如下：
...
$_LANG['affiliate_intro'][1] = '　　本网站为鼓励推荐新用户注册，现开展<b>推荐报名分成</b>活动，活动流程如下：

　　１、在浏览课程时，点击推荐此课程，获得推荐代码，将其发送到论坛、博客上。
　　２、访问者点击链接，访问网站。
　　３、在访问者点击链接的 <b>%d%s</b> 内，若该访问者在本站报名，即认定该用户是您推荐的。
　　４、您将获得该报名单金额的 <b>%s</b> 、积分的 <b>%s</b>的奖励。
　　５、提成由管理员人工审核发放，请您耐心等待。
　　６、您可以通过分成明细来查看您的介绍、分成情况。';
