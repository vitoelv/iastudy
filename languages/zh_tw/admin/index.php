...
$_LANG['menu'] = '選單';
$_LANG['help'] = '說明';
$_LANG['signout'] = '登出管理中心';
$_LANG['profile'] = '個人設定';
$_LANG['view_message'] = '管理員留言';
$_LANG['send_msg'] = '發送留言';
$_LANG['toggle_calculator'] = '小算盤';
$_LANG['expand_all'] = '展開';
$_LANG['collapse_all'] = '收合';
$_LANG['no_help'] = '暫時還沒有該部分內容';

$_LANG['js_languages']['expand_all'] = '展開';
$_LANG['js_languages']['collapse_all'] = '收合';

/*------------------------------------------------------ */
//-- 計算器
/*------------------------------------------------------ */

$_LANG['calculator'] = '小算盤';
...
$_LANG['ip_version'] = 'IP 資料庫版本：';
$_LANG['max_filesize'] = '檔案上傳的最大大小：';
...
$_LANG['remove_install'] = '您還沒有刪除 install 資料夾，出於安全的考慮，我們建議您刪除 install 資料夾。';
$_LANG['remove_upgrade'] = '您還沒有刪除 upgrade 資料夾，出於安全的考慮，我們建議您刪除 upgrade 資料夾。';
$_LANG['temp_dir_cannt_read'] = '您的伺服器設定了 open_base_dir 且沒有包含 %s，您將無法上傳檔案。';
$_LANG['not_writable'] = '%s 目錄不可寫入，%s';
$_LANG['data_cannt_write'] = '您將無法上傳包裝、賀卡、品牌等等圖片檔案。';
$_LANG['afficheimg_cannt_write'] = '您將無法上傳廣告的圖片檔案。';
$_LANG['brandlogo_cannt_write'] = '您將無法上傳品牌的圖片檔案。';
$_LANG['cardimg_cannt_write'] = '您將無法上傳賀卡的圖片檔案。';
$_LANG['feedbackimg_cannt_write'] = '使用者將無法透過留言上傳檔案。';
$_LANG['packimg_cannt_write'] = '您將無法上傳包裝的圖片檔案。';
$_LANG['cert_cannt_write'] = '您將無法上傳營利事業登記證書檔案。';
$_LANG['images_cannt_write']= '您將無法上傳任何商品圖片。';
$_LANG['imagesupload_cannt_write']= '您將無法透過編輯器上傳任何圖片。';
$_LANG['tpl_cannt_write'] = '您的網站將無法瀏覽。';
$_LANG['tpl_backup_cannt_write'] = '您就無法備份目前的版型檔案。';
$_LANG['order_print_canntwrite'] = 'data目錄下的order_print.html檔案屬性為不可寫，您將無法修改訂單列印樣板。';
$_LANG['shop_closed_tips'] = '您的商店已被暫時關閉。在設定好您的商店之後別忘記打開哦！';
$_LANG['empty_upload_tmp_dir'] = '目前的上傳臨時目錄為空，您可能無法上傳檔案，請檢查 php.ini 中的設定。';
$_LANG['caches_cleared'] = '網頁暫存檔案已經清除成功。';
